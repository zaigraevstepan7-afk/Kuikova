...
0x001d7a30: ldr      x8, [x8, #0x5a8]  ; mem
0x001d7a34: blr      x8  ; indirect call
0x001d7a38: ldr      x8, [x19, #0x160]  ; mem
0x001d7a3c: cbz      x8, #0x1d7df8
0x001d7a40: adrp     x21, #0x279000
0x001d7a44: mov      x1, x19
0x001d7a48: ldr      x0, [x21, #0x4f8]  ; mem
0x001d7a4c: bl       #0x1d8968  ; -> 0x1d8968
0x001d7a50: ldr      x0, [x21, #0x4f8]  ; mem
0x001d7a54: bl       #0x1d8a80  ; -> 0x1d8a80
0x001d7a58: ldr      x8, [x19, #0x160]  ; mem
0x001d7a5c: ldrb     w8, [x8, #0x30]  ; mem
0x001d7a60: cbz      w8, #0x1d7af0
0x001d7a64: adrp     x8, #0x279000
0x001d7a68: str      x19, [x8, #0x5b0]  ; mem
0x001d7a6c: bl       #0x26c530  ; -> _ZNSt6__ndk16chrono12steady_clock3nowEv
...
0x001d7a90: ldr      x9, [x8, #0x5b8]  ; mem
0x001d7a94: sub      x9, x22, x9
0x001d7a98: cmp      x9, #0xfa
0x001d7a9c: b.lo     #0x1d7c14
0x001d7aa0: nop      
0x001d7aa4: adr      x1, #0x279660  ; global 0x279660
0x001d7aa8: movz     w0, #0x1
0x001d7aac: str      x22, [x8, #0x5b8]  ; mem
0x001d7ab0: bl       #0x268190  ; -> 0x268190
0x001d7ab4: adrp     x8, #0x279000
0x001d7ab8: adrp     x24, #0x279000
0x001d7abc: ldr      x8, [x8, #0x4f0]  ; mem
...
0x001d7d68: str      xzr, [x8, #0x68]  ; mem
0x001d7d6c: str      wzr, [x8, #0x70]  ; mem
0x001d7d70: str      w10, [x9, #0x60]  ; mem
0x001d7d74: adrp     x8, #0x279000
0x001d7d78: ldrb     w8, [x8, #0x5d2]  ; mem
0x001d7d7c: cbz      w8, #0x1d7dbc
0x001d7d80: ldr      x8, [x19, #0xe8]  ; mem
0x001d7d84: cbz      x8, #0x1d7dbc
0x001d7d88: ldr      x8, [x8, #0x28]  ; mem
0x001d7d8c: cbz      x8, #0x1d7dbc
0x001d7d90: ldr      x0, [x8, #0x30]  ; mem
0x001d7d94: cbz      x0, #0x1d7dbc
0x001d7d98: adrp     x8, #0x279000
0x001d7d9c: movz     w9, #0x7bc0
0x001d7da0: mov      x1, xzr
0x001d7da4: ldr      x8, [x8, #0x4f0]  ; mem
0x001d7da8: movk     w9, #0x5fb, lsl #16
0x001d7dac: add      x8, x8, x9
0x001d7db0: adrp     x9, #0x37000
0x001d7db4: ldr      s0, [x9, #0xe90]  ; mem
0x001d7db8: blr      x8  ; indirect call
0x001d7dbc: mov      x0, x19
0x001d7dc0: bl       #0x1d9e00  ; -> 0x1d9e00
0x001d7dc4: adrp     x8, #0x279000
0x001d7dc8: ldrb     w8, [x8, #0x5d4]  ; mem
0x001d7dcc: cbz      w8, #0x1d7df8
0x001d7dd0: adrp     x8, #0x279000
0x001d7dd4: ldr      x0, [x8, #0x538]  ; mem
