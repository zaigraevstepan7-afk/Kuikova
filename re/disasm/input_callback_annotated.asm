...
0x001d7644: bl       #0x26c490  ; -> AInputEvent_getType
0x001d7648: cmp      w0, #2
0x001d764c: b.ne     #0x1d76c4
0x001d7650: mov      x0, x20
0x001d7654: bl       #0x26c4a0  ; -> AMotionEvent_getAction
0x001d7658: mov      w21, w0
0x001d765c: nop      
0x001d7660: adr      x0, #0x27954c  ; global 0x27954c
0x001d7664: bl       #0x26c4b0  ; -> _ZNSt6__ndk15mutex4lockEv
0x001d7668: mov      x0, x20
0x001d766c: mov      x1, xzr
0x001d7670: bl       #0x26c4c0  ; -> AMotionEvent_getX
0x001d7674: adrp     x8, #0x279000
0x001d7678: str      s0, [x8, #0x650]  ; mem
0x001d767c: mov      x0, x20
0x001d7680: mov      x1, xzr
0x001d7684: bl       #0x26c4d0  ; -> AMotionEvent_getY
0x001d7688: movz     w8, #0xfd
0x001d768c: adrp     x9, #0x279000
0x001d7690: ands     w8, w21, w8
0x001d7694: str      s0, [x9, #0x654]  ; mem
...
0x001d76b4: strb     w8, [x9, #0x658]  ; mem
0x001d76b8: nop      
0x001d76bc: adr      x0, #0x27954c  ; global 0x27954c
0x001d76c0: bl       #0x26c4e0  ; -> _ZNSt6__ndk15mutex6unlockEv
0x001d76c4: mov      x0, x19
0x001d76c8: ldp      x20, x19, [sp, #0x20]
0x001d76cc: ldr      x21, [sp, #0x10]  ; mem
0x001d76d0: ldp      x29, x30, [sp], #0x30
0x001d76d4: ret      
0x001d76d8: mov      x19, x0
0x001d76dc: nop      
0x001d76e0: adr      x0, #0x27954c  ; global 0x27954c
0x001d76e4: bl       #0x26c4e0  ; -> _ZNSt6__ndk15mutex6unlockEv
0x001d76e8: mov      x0, x19
0x001d76ec: bl       #0x26841c  ; -> 0x26841c
