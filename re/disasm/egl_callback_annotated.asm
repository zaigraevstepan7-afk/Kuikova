...
0x001d7710: nop      
0x001d7714: adr      x21, #0x27965c  ; global 0x27965c
0x001d7718: ldr      x8, [x22, #0x28]  ; mem
...
0x001d77b8: bl       #0x26c510  ; -> clock_gettime
0x001d77bc: nop      
0x001d77c0: adr      x8, #0x279588  ; global 0x279588
...
0x001d77e8: ldr      s2, [x9, #0xf58]  ; mem
...
0x001d7800: ldr      s0, [x9, #0xea0]  ; mem
0x001d7804: fcsel    s0, s1, s0, gt
0x001d7808: str      s0, [x21, #0x18]  ; mem
0x001d780c: ldr      q0, [sp, #0x10]  ; mem
0x001d7810: nop      
0x001d7814: adr      x0, #0x27954c  ; global 0x27954c
0x001d7818: str      q0, [x8]
0x001d781c: bl       #0x26c4b0  ; -> _ZNSt6__ndk15mutex4lockEv
0x001d7820: adrp     x8, #0x279000
0x001d7824: adrp     x9, #0x279000
0x001d7828: ldr      s0, [x8, #0x650]  ; mem
0x001d782c: ldr      s1, [x9, #0x654]  ; mem
0x001d7830: mov      x0, x21
0x001d7834: bl       #0x1ebd9c  ; -> 0x1ebd9c
0x001d7838: adrp     x8, #0x279000
0x001d783c: ldrb     w2, [x8, #0x658]  ; mem
0x001d7840: mov      x0, x21
0x001d7844: mov      w1, wzr
0x001d7848: bl       #0x1ebf60  ; -> 0x1ebf60
0x001d784c: nop      
0x001d7850: adr      x0, #0x27954c  ; global 0x27954c
0x001d7854: bl       #0x26c4e0  ; -> _ZNSt6__ndk15mutex6unlockEv
0x001d7858: bl       #0x22eaf8  ; -> 0x22eaf8
0x001d785c: bl       #0x1f3570  ; -> 0x1f3570
0x001d7860: adrp     x10, #0x279000
0x001d7864: ldr      w8, [sp, #0x20]  ; mem
0x001d7868: ldur     w9, [x29, #-0x1c]
0x001d786c: ldr      x0, [x10, #0x510]  ; mem
0x001d7870: adrp     x23, #0x279000
0x001d7874: adrp     x24, #0x279000
0x001d7878: str      w8, [x23, #0x598]  ; mem
0x001d787c: str      w9, [x24, #0x59c]  ; mem
0x001d7880: bl       #0x1da768  ; -> 0x1da768
0x001d7884: adrp     x8, #0x279000
0x001d7888: ldrb     w8, [x8, #0x5a0]  ; mem
0x001d788c: cbz      w8, #0x1d7894
0x001d7890: bl       #0x1e955c  ; -> 0x1e955c
0x001d7894: adrp     x8, #0x279000
0x001d7898: ldrb     w8, [x8, #0x5a1]  ; mem
0x001d789c: cbz      w8, #0x1d78fc
0x001d78a0: adrp     x8, #0x279000
0x001d78a4: ldrb     w8, [x8, #0x5a2]  ; mem
0x001d78a8: cbz      w8, #0x1d78fc
0x001d78ac: ldr      s0, [x24, #0x59c]  ; mem
0x001d78b0: ldr      s1, [x23, #0x598]  ; mem
0x001d78b4: fmov     s2, #0.50000000
0x001d78b8: nop      
0x001d78bc: adr      x0, #0x278ff8  ; imm 0x278ff8
0x001d78c0: scvtf    s0, s0
0x001d78c4: scvtf    s1, s1
0x001d78c8: fmul     s0, s0, s2
0x001d78cc: fmul     s1, s1, s2
0x001d78d0: stp      s0, s1, [sp, #0x10]
0x001d78d4: bl       #0x1ed030  ; -> 0x1ed030
0x001d78d8: mov      w21, w0
0x001d78dc: bl       #0x1f288c  ; -> 0x1f288c
0x001d78e0: adrp     x8, #0x279000
0x001d78e4: fmov     s1, #2.00000000
0x001d78e8: add      x1, sp, #0x10
0x001d78ec: ldr      s0, [x8, #0x5a4]  ; mem
0x001d78f0: mov      w2, w21
0x001d78f4: movz     w3, #0x40
0x001d78f8: bl       #0x208f88  ; -> 0x208f88
