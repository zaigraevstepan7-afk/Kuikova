...
0x001d69ec: str      x21, [sp, #0x30]  ; mem
0x001d69f0: stp      x20, x19, [sp, #0x40]
0x001d69f4: add      x29, sp, #0x20
0x001d69f8: mrs      x21, tpidr_el0
0x001d69fc: movz     w0, #0x8
0x001d6a00: ldr      x8, [x21, #0x28]  ; mem
0x001d6a04: stur     x8, [x29, #-8]
0x001d6a08: bl       #0x26c330  ; -> _Znwm
0x001d6a0c: mov      x20, x0
0x001d6a10: bl       #0x26c340  ; -> _ZNSt6__ndk115__thread_structC1Ev
0x001d6a14: movz     w0, #0x8
0x001d6a18: bl       #0x26c330  ; -> _Znwm
0x001d6a1c: mov      x3, x0
0x001d6a20: str      x20, [x0]
0x001d6a24: str      x0, [sp, #0x10]  ; mem
0x001d6a28: nop      
0x001d6a2c: adr      x2, #0x1d6afc  ; imm 0x1d6afc
0x001d6a30: add      x0, sp, #8
0x001d6a34: mov      x1, xzr
0x001d6a38: bl       #0x26c350  ; -> pthread_create
0x001d6a3c: cbnz     w0, #0x1d6a88
0x001d6a40: add      x0, sp, #0x10
0x001d6a44: str      xzr, [sp, #0x10]  ; mem
0x001d6a48: bl       #0x1d6d04  ; -> 0x1d6d04
0x001d6a4c: add      x0, sp, #8
0x001d6a50: bl       #0x26c360  ; -> _ZNSt6__ndk16thread6detachEv
0x001d6a54: add      x0, sp, #8
0x001d6a58: bl       #0x26c370  ; -> _ZNSt6__ndk16threadD1Ev
0x001d6a5c: ldr      x8, [x21, #0x28]  ; mem
