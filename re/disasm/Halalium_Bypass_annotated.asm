...
0x001d90bc: str      x23, [sp, #0x10]  ; mem
...
0x001d90e4: bl       #0x26c540  ; -> __android_log_print
0x001d90e8: nop      
0x001d90ec: adr      x20, #0x2796d8  ; global 0x2796d8
0x001d90f0: ldp      x21, x22, [x20]
0x001d90f4: cmp      x21, x22
0x001d90f8: b.eq     #0x1d9108
0x001d90fc: ldr      x0, [x21], #0x18  ; mem
0x001d9100: bl       #0x26c590  ; -> DobbyDestroy
0x001d9104: b        #0x1d90f4
0x001d9108: adrp     x8, #0x279000
0x001d910c: mov      x0, x19
0x001d9110: ldr      x8, [x8, #0x6f0]  ; mem
0x001d9114: blr      x8  ; indirect call
...
0x001d916c: ldr      x23, [sp, #0x10]  ; mem
0x001d9170: ldp      x22, x21, [sp, #0x20]
0x001d9174: ldp      x29, x30, [sp], #0x40
0x001d9178: ret      
0x001d917c: stp      x29, x30, [sp, #-0x40]!
