...
static void apply_imgui_style()
{
    ...
    // Kikaium teal theme — not Halalium grey/blue clone.
    const ImVec4 teal = ImVec4(0.18f, 0.72f, 0.64f, 1.00f);
    const ImVec4 teal_dim = ImVec4(0.12f, 0.42f, 0.38f, 1.00f);
    const ImVec4 bg = ImVec4(0.05f, 0.06f, 0.07f, 0.98f);
    const ImVec4 bg2 = ImVec4(0.07f, 0.09f, 0.09f, 1.00f);
    ...
    style->Colors[ImGuiCol_Text] = ImVec4(0.92f, 0.95f, 0.94f, 1.00f);
    style->Colors[ImGuiCol_TextDisabled] = ImVec4(0.45f, 0.50f, 0.48f, 1.00f);
    style->Colors[ImGuiCol_WindowBg] = bg;
    style->Colors[ImGuiCol_ChildBg] = bg2;
    style->Colors[ImGuiCol_PopupBg] = ImVec4(0.08f, 0.10f, 0.10f, 0.96f);
    style->Colors[ImGuiCol_Border] = ImVec4(0.14f, 0.20f, 0.18f, 1.00f);
    style->Colors[ImGuiCol_BorderShadow] = ImVec4(0, 0, 0, 0);
    style->Colors[ImGuiCol_FrameBg] = ImVec4(0.09f, 0.11f, 0.11f, 1.00f);
    style->Colors[ImGuiCol_FrameBgHovered] = ImVec4(0.12f, 0.18f, 0.17f, 1.00f);
    style->Colors[ImGuiCol_FrameBgActive] = teal_dim;
    style->Colors[ImGuiCol_TitleBg] = bg;
    style->Colors[ImGuiCol_TitleBgActive] = teal_dim;
    style->Colors[ImGuiCol_TitleBgCollapsed] = bg;
    style->Colors[ImGuiCol_MenuBarBg] = bg2;
    style->Colors[ImGuiCol_ScrollbarBg] = bg;
    style->Colors[ImGuiCol_ScrollbarGrab] = teal_dim;
    style->Colors[ImGuiCol_ScrollbarGrabHovered] = teal;
    style->Colors[ImGuiCol_ScrollbarGrabActive] = teal;
    style->Colors[ImGuiCol_CheckMark] = teal;
    style->Colors[ImGuiCol_SliderGrab] = teal;
    style->Colors[ImGuiCol_SliderGrabActive] = ImVec4(0.35f, 0.90f, 0.80f, 1.00f);
    style->Colors[ImGuiCol_Button] = ImVec4(0.10f, 0.14f, 0.13f, 1.00f);
    style->Colors[ImGuiCol_ButtonHovered] = teal_dim;
    style->Colors[ImGuiCol_ButtonActive] = teal;
    style->Colors[ImGuiCol_Header] = teal_dim;
    style->Colors[ImGuiCol_HeaderHovered] = ImVec4(0.16f, 0.50f, 0.45f, 1.00f);
    style->Colors[ImGuiCol_HeaderActive] = teal;
    style->Colors[ImGuiCol_Separator] = ImVec4(0.18f, 0.28f, 0.26f, 0.80f);
    style->Colors[ImGuiCol_SeparatorHovered] = teal;
    style->Colors[ImGuiCol_SeparatorActive] = teal;
    style->Colors[ImGuiCol_ResizeGrip] = teal_dim;
    style->Colors[ImGuiCol_ResizeGripHovered] = teal;
    style->Colors[ImGuiCol_ResizeGripActive] = teal;
    style->Colors[ImGuiCol_Tab] = bg2;
    style->Colors[ImGuiCol_TabHovered] = teal_dim;
    style->Colors[ImGuiCol_TabSelected] = teal_dim;
    style->Colors[ImGuiCol_TabSelectedOverline] = teal;
    style->Colors[ImGuiCol_TabDimmed] = bg;
    style->Colors[ImGuiCol_TabDimmedSelected] = teal_dim;
    style->Colors[ImGuiCol_TextSelectedBg] = ImVec4(0.18f, 0.72f, 0.64f, 0.35f);
