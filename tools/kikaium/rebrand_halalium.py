...
EXACT: list[tuple[bytes, bytes]] = [
    ...
    (b"Reverse Spin", b"Invert Twist"),
    (b"Jitter Speed", b"Jitter Tempo"),
    (b"Skin Changer", b"Item Changer"),
    (b"Item Picker", b"Item Browse"),
    (b"Accent Color", b"Theme Accent"),
    (b"Health Bar", b"Vitals Bar"),
    (b"Box Type", b"Box Mode"),
    (b"Lemming", b"Kikaium"),
]
